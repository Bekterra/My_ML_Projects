...
EmpAdd <- read.csv("Employee_Addresses.csv")
...
library(ggmap)
# get the input data
infile <- "/Users/bekterra/Desktop/Hackatons/Bus Stop Optimization/Bus/Employee_Addresses.csv"
...
if (file.exists(tempfilename))
{
  ...
  geocoded<- geocoded[-nrow(geocoded), ]
...
# Saving geocoded employee addresses dataframe as csv data 
#write.csv(geocoded, file = "/Users/bekterra/Desktop/Hackatons/Bus Stop Optimization/Bus/geocodedEmpl.csv")
